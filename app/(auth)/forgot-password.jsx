...
import { checkPasswordStrength, forgotPasswordSchema } from '@/src/utils/validation';
...
const ForgotPassword = () => {
  ...
  const handleSendCode = async () => {
    ...
    try {
      ...
      // TODO: 调用发送验证码 API
      // await sendVerificationCode({ phone, type: 'reset' });
    ...
    >
      ...
      >
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.subtitle}>通过手机号验证找回密码</Text>
        </View>
            ...
            <Controller
              ...
              render={({ field: { onChange, value } }) => (
                <Input
                  value={value}
                  onChangeText={onChange}
                  placeholder="设置新密码（6-20位，含字母和数字）"
        ...
        <View style={styles.footer}>
          <TouchableOpacity onPress={() => router.push('/(auth)/login')}>
            <Text style={styles.backToLogin}>← 返回登录</Text>
          </TouchableOpacity>
        </View>
      </ScrollView>
